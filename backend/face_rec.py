...
Akansha = FaceRec('./images/Akansha.jpg', './stranger', 'Akansha')
Sachin = FaceRec('./images/sachin.jpeg','./stranger', 'Sachin')
Amitabh = FaceRec('./images/amitabh.jpeg','./stranger', 'Amitabh')
Selena = FaceRec('./images/selena.jpg','./stranger', 'Selena')
